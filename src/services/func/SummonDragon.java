...
public class SummonDragon {
    ...
    private final int timeResummonShenron = 10000;
    ...
    private void activeShenron(Player pl, boolean appear, byte type) {
        ...
        try {
            ...
            if (appear) {
                ...
                msg.writer().writeUTF("Nro-Ultrakill");
                ...
                switch (this.select) {
                    case 0: //đẹp trai nhất vũ trụ
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            avtVip.itemOptions.add(new ItemOption(50, Util.nextInt(5, 35)));
                            avtVip.itemOptions.add(new ItemOption(101, Util.nextInt(10, 15)));
                            avtVip.itemOptions.add(new ItemOption(5, Util.nextInt(5, 30)));
