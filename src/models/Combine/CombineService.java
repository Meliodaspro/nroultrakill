...
//            msg.writer().writeShort(-1); // y
    ...
    public void sendAddItemCombine(Player player, int npcId, Item... items) {
        ...
        try {
            msg = new Message(-81);
            msg.writer().writeByte(0);
            msg.writer().writeUTF("By USEntertainment");
            msg.writer().writeUTF("Nro-Ultrakill - Đẳng Cấp Là Mãi Mãi");
    ...
    private String getTextInfoTabCombine(int type) {
        return switch (type) {
            ...
            case AN_TRANG_BI ->
                "Vào hành trang\nChọn 1 Trang bị(Áo, Quần ,Giày ,Găng ,Rada) Thần Linh hoặc Hủy Diệt và 20 mảnh Ấn\nSau đó chọn 'Làm phép'\n--------\nTinh ấn (5 món +15%sd)\n Nhật ấn (5 món +15%hp\n Nguyệt ấn (5 món +15%ki)";
