...
public class Message
    ...
    public void writeLongByEmti(long v, boolean readInt) throws IOException {
        if (readInt) {
            writeInt((int) v);
        } else {
            writeLong(v);
    ...
    public long readLongByEmti(boolean readInt) throws IOException {
        return readInt ? reader().readInt() : reader().readLong();
    }
