...
public class ShopService {
    ...
    private void buyItemVND(Player player, int itemTempId) {//Zalo: 0358124452//Name: EMTI 
        Shop shop = player.iDMark.getShopOpen();
        ItemShop is = shop.getItemShop(itemTempId);
        int pointExchange = 0;
    ...
    private void buyItemNHS(Player player, int itemTempId) {//Zalo: 0358124452//Name: EMTI 
        Shop shop = player.iDMark.getShopOpen();
        ItemShop is = shop.getItemShop(itemTempId);
        int pointExchange = 0;
    ...
    private void buyItemBHM(Player player, int itemTempId) {//Zalo: 0358124452//Name: EMTI 
        Shop shop = player.iDMark.getShopOpen();
        ItemShop is = shop.getItemShop(itemTempId);
        int pointExchange = 0;
    ...
    }private void buyItemQuyLao(Player player, int itemTempId) {//Zalo: 0358124452//Name: EMTI 
        Shop shop = player.iDMark.getShopOpen();
        ItemShop is = shop.getItemShop(itemTempId);
        int pointExchange = 0;
    ...
    public void buyItem(Player player, int itemTempId) {
        ...
        } else if (shop.tagName.equals("SHOP_VND")) {//Zalo: 0358124452//Name: EMTI 
            if (!subMoneyByItemShop(player, is)) {//Zalo: 0358124452//Name: EMTI 
                return;
            }

        } else if (shop.tagName.equals("SHOP_NHS")) {//Zalo: 0358124452//Name: EMTI 
            if (!subMoneyByItemShop(player, is)) {//Zalo: 0358124452//Name: EMTI 
                return;
            }

        } else if (shop.tagName.equals("SHOP_BHM")) {//Zalo: 0358124452//Name: EMTI 
            if (!subMoneyByItemShop(player, is)) {//Zalo: 0358124452//Name: EMTI 
                return;
            }

        } else if (shop.tagName.equals("SHOP_QUY_LAO")) {//Zalo: 0358124452//Name: EMTI 
            if (!subMoneyByItemShop(player, is)) {//Zalo: 0358124452//Name: EMTI 
                return;
            }
